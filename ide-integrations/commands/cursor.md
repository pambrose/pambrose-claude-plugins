---
description: Open Cursor editor with the current directory as the project root. Responds to "open cursor".
---
...
If the command fails, tell the user that Cursor could not be found and suggest they verify it is installed
