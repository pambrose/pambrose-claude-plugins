...
| Plugin | Description |
|--------|-------------|
| [linear-integration](linear-integration/README.md) | Linear integration: fix issues autonomously in worktrees, create PRs, request Codex CLI reviews, and run systematic codebase reviews |
